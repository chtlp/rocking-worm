...
public class Test3 {
	...
	public static void main(String[] args) throws Exception {
		...
		fcv = new FloatConstValue(0, (float) 0.8);
		...
		ColNameValue wherecnv = new ColNameValue(0, new ColName(null, "B"));
		FloatConstValue whereicv = new FloatConstValue(0, (float) 0.7);
		Cop wherecop = new Cop(Cop.GtEq);
		CopValue wherecopv = new CopValue(0, wherecnv, whereicv, wherecop);
		...
		HasWhere hasWhere =  new HasWhere(wherecopv, hasGroup);
