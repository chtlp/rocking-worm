...
import static logging.Page.BLOCK_SIZE;
...
/**
 * The file manager. The database system stores its data as files within a
 * specified directory. The file manager provides methods for reading the
 * contents of a file block to a Java byte buffer, writing the contents of a
 ...
 * {@link logging.Page Page}, and are thus package-private. The class also
 * contains two public methods: Method {@link #isNew() isNew} is called during
 * system initialization. Method {@link #size(String) size} is called by the log
 * manager and transaction manager to determine the end of the file.
 */
public class FileManager {
	 ...
	 */
	public FileManager() {
		String homedir = "." + File.separator;
		dbDirectory = new File(homedir);
